...
below code should dynamically generate columns with content. does not work. The reason is that ojs code is executed after the document has been rendered, and not before, like with R or Python. 
